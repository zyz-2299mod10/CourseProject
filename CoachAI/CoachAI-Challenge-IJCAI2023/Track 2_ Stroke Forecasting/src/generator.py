...
if __name__ == "__main__":
    ...
    for rally_id in tqdm(testing_rallies):
        # read data
        selected_matches = test_matches.loc[(test_matches['rally_id'] == rally_id)][['rally_id', 'type', 'landing_x', 'landing_y', 'player', 'rally_length', 'player_location_x', 'player_location_y']].reset_index(drop=True)
